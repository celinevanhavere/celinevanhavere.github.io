...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [485546.306658, 6654823.979786, 497008.426221, 6662861.937181], maxZoom: 20, minZoom: 1
    })
});
...
map.getView().fit([485546.306658, 6654823.979786, 497008.426221, 6662861.937181], map.getSize());
